...
//	real INIT_TIME = 1.0; // [s]
	...
	const std::string state_id = fmt::format("sim_IBM2_{}_{}_dirac_{}_res_{}_Re_{}_nas_{:05.4f}_compute_{}", NSE::COLL::id, method, dirac, RES, Re, discretization_ratio, compute);
