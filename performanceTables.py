...
def main():
    ...
    if args.build :
        subprocess.run(["cmake -B build -DHA_CAPACITY_VARIANT="+str(args.variantHaCapacities)+" -DHA_VARIANT="+str(args.variantHa)], shell=True, check=True)
    ...
    filename = args.output +"_threads-"+str(args.threads)+"_"+variantString+".txt"
